	...
	const fields = useMemo(() => {
		const fields = {
			...
			description: {
				...
				description: t.rich("authenticated.fields.description.description", {
					Link(chunks) {
						return <a href="https://commonmark.org/help/">{chunks}</a>;
					},
				}),
				isRequired: true,
			},
			...
			externalIds: {
				...
				fields: {
					...
					identifierService: {
						...
						description: t("authenticated.fields.externalIds.identifierService.description"),
					},
				},
			},
			contributors: {
