...
export function ListBoxEmptyState(props: Readonly<ListBoxEmptyStateProps>): ReactNode {
	...
	return (
		<div
			{...rest}
			className={cn(
				"text-text-weak relative inline-flex cursor-default items-center gap-x-3 py-3 pr-12 pl-4 italic transition will-change-transform forced-color-adjust-none select-none slot-icon:size-5 slot-icon:shrink-0 slot-icon:text-neutral-700",
				className,
			)}
		>
			{children}
