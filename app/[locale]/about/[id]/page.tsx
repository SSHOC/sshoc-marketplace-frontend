...
export async function generateStaticParams(props: {
	params: Pick<AboutPageProps["params"], "locale">;
}): Promise<Array<Pick<AboutPageProps["params"], "id">>> {
	const { params } = props;

	const { locale } = params;
	const ids = await reader().collections.about.list();
...
export async function generateMetadata(
	...
	const document = await reader().collections.about.read(id);
...
export default function AboutPage(props: AboutPageProps): ReactNode {
	const { params } = props;
