...
import type { RelatedItemInput } from "@/lib/data/sshoc/api/item";
...
export function RelatedItemsFormFieldArray(
  props: RelatedItemsFormFieldArrayProps
): JSX.Element {
  const { field } = props;

  const { t } = useI18n<"authenticated" | "common">();
  const fieldArray = useFieldArray<
    RelatedItemInput | UndefinedLeaves<RelatedItemInput>
