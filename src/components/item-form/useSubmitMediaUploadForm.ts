...
import type { MediaDetails } from "@/lib/data/sshoc/api/media";
import { useImportMedia, useUploadMedia } from "@/lib/data/sshoc/hooks/media";
...
export type UseSubmitMediaUploadFormResult = (
