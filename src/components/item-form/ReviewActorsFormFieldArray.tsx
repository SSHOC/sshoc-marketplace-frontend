...
import type { ItemContributorRef, ItemsDiff } from "@/lib/data/sshoc/api/item";
...
export function ReviewActorsFormFieldArray(
  props: ReviewActorsFormFieldArrayProps
): JSX.Element {
  const { field } = props;

  const { t } = useI18n<"authenticated" | "common">();
  const fieldArray = useFieldArray<
    ItemContributorRef | UndefinedLeaves<ItemContributorRef>
                ...
                <Fragment>
                  ...
                  <FormFieldListItemControls>
                    ...
                    <FormRecordRemoveButton
                      aria-label={t(
                        ["authenticated", "forms", "remove-field"],
                        {
