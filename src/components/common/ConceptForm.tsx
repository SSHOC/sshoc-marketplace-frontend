...
import type { ConceptInput, Vocabulary } from "@/lib/data/sshoc/api/vocabulary";
import {
  conceptInputSchema,
  vocabularyRefSchema,
} from "@/lib/data/sshoc/validation-schemas/vocabulary";
...
export type ConceptFormValues = ConceptInput & {
  vocabulary: { code: Vocabulary["code"] };
};
    ...
    <Form
      ...
      validate={async (values) => {
        const result = await validateSchema(
          conceptInputSchema.merge(
            z.object({ vocabulary: vocabularyRefSchema })
          )
        )(
