...
export function CreateActorButton(props: CreateActorButtonProps): JSX.Element {
  ...
  const meta: MutationMetadata = {
    messages: {
      mutate() {
        return t('actors.create-actor-pending')
      },
      success() {
        return t('actors.create-actor-success')
      },
      error() {
        return t('actors.create-actor-error')
      },
    },
  }
