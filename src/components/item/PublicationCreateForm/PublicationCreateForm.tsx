...
import { useCreatePublication, useUpdatePublication } from '@/api/sshoc'
...
export function ItemForm(props: ItemFormProps<ItemFormValues>): JSX.Element {
  ...
  const useItemMutation =
    persistentIdFromSavedDraft != null ? useUpdatePublication : useCreatePublication
