...
import type { Item, ItemCategory, ItemStatus } from "@/lib/data/sshoc/api/item";
import { useDeleteDatasetVersion } from "@/lib/data/sshoc/hooks/dataset";
import { useDeletePublicationVersion } from "@/lib/data/sshoc/hooks/publication";
import { useDeleteToolVersion } from "@/lib/data/sshoc/hooks/tool-or-service";
import { useDeleteTrainingMaterialVersion } from "@/lib/data/sshoc/hooks/training-material";
import { useDeleteWorkflowVersion } from "@/lib/data/sshoc/hooks/workflow";
...
export function ItemVersionControls(
  props: ItemVersionControlsProps
): JSX.Element {
...
function DeleteItemVersionButton(props: DeleteItemButtonProps): JSX.Element {
  ...
  const deleteItemVersion = useDeleteItemVersion(category)(
    { persistentId, versionId },
    undefined,
    {
      meta,
