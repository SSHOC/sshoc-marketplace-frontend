...
import type { Item, ItemComment } from "@/lib/data/sshoc/api/item";
import { useLastItemComments } from "@/lib/data/sshoc/hooks/item";
    ...
    <article className={css["comment"]}>
      <dl className={css["comment-metadata"]}>
        ...
        <div>
          <dt>
            <VisuallyHidden>
              {t(["common", "item", "date-last-modified"])}
            </VisuallyHidden>
          </dt>
          <dd>
