...
import type { Property } from "@/lib/data/sshoc/api/property";
...
export function ItemProperties(props: ItemPropertiesProps): JSX.Element {
  ...
  return (
    <div>
      <dt>
        <VisuallyHidden>
          {t(["common", "item", "properties", "other"])}
        </VisuallyHidden>
      </dt>
      <dd>
                      ...
                      return (
                        <div key={label} className={css["value-group"]}>
                          ...
                          <dd>
                            <ul
                              role="list"
                              className={css["value-group-items"]}
                            >
      ...
      return [
        ...
        Array.from(group)
          .sort(([_label, properties], [_otherLabel, otherProperties]) => {
            /* eslint-disable-next-line @typescript-eslint/no-non-null-assertion */
            return properties[0]!.type.ord > otherProperties[0]!.type.ord
              ? 1
              : -1;
          })
