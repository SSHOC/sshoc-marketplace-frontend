...
import type { ItemsDifferencesDto, PublicationCore, PublicationDto } from '@/api/sshoc'
import { useDeletePublicationVersion, useUpdatePublication } from '@/api/sshoc'
...
export function ItemForm(props: ItemFormProps<ItemFormValues>): JSX.Element {
  ...
  const rejectVersion = useDeletePublicationVersion({
    onSuccess() {
