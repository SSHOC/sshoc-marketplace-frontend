...
export interface UseSessionResult {
  ...
  updateSessionState: (
    status: Exclude<SessionStatus, "signedIn" | "signedOut">
  ) => void;
}
...
const redirectUrls = {
  success: createSiteUrl({
    searchParams: {
      [redirectSearchParamKey]: redirectSearchParamValues.success,
    },
  }),
  registration: createSiteUrl({
    pathname: routes.SignUpPage().pathname,
    searchParams: {
      [redirectSearchParamKey]: redirectSearchParamValues.registration,
    },
  }),
  error: createSiteUrl({
