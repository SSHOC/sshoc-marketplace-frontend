...
import type { Source } from "@/lib/data/sshoc/api/source";
...
import { datasetInputSchema } from "@/lib/data/sshoc/validation-schemas/dataset";
...
export function getDataset(
  ...
  const url = createUrl({
    pathname: `/api/datasets/${params.persistentId}`,
    searchParams: params,
  });
  const options: RequestOptions = { ...requestOptions };
...
export function getDatasetHistory(
  ...
  const url = createUrl({
    pathname: `/api/datasets/${params.persistentId}/history`,
  });
  const options: RequestOptions = { ...requestOptions };
...
export function commitDraftDataset(
  ...
  const url = createUrl({
    pathname: `/api/datasets/${params.persistentId}/commit`,
  });
...
export function getDatasetSources(
  ...
  const url = createUrl({
    pathname: `/api/datasets/${params.persistentId}/sources`,
  });
  const options: RequestOptions = { ...requestOptions };
