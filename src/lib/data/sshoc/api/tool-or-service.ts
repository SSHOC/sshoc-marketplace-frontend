...
import { toolInputSchema } from "@/lib/data/sshoc/validation-schemas/tool";
...
export function getToolHistory(
  ...
  const url = createUrl({
    pathname: `/api/tools-services/${params.persistentId}/history`,
  });
  const options: RequestOptions = { ...requestOptions };
...
export function commitDraftTool(
  ...
  const url = createUrl({
    pathname: `/api/tools-services/${params.persistentId}/commit`,
  });
...
export function mergeTools(
  ...
  const url = createUrl({
    pathname: "/api/tools-services/merge",
    searchParams: params,
  });
  const json = toolInputSchema.parse(data);
  const options: RequestOptions = { ...requestOptions, method: "post", json };
...
export function getToolSources(
  ...
  const url = createUrl({
    pathname: `/api/tools-services/${params.persistentId}/sources`,
  });
  const options: RequestOptions = { ...requestOptions };
