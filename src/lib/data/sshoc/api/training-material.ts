...
import { trainingMaterialInputSchema } from "@/lib/data/sshoc/validation-schemas/training-material";
...
export function getTrainingMaterialHistory(
  ...
  const url = createUrl({
    pathname: `/api/training-materials/${params.persistentId}/history`,
  });
  const options: RequestOptions = { ...requestOptions };
...
export function commitDraftTrainingMaterial(
  ...
  const url = createUrl({
    pathname: `/api/training-materials/${params.persistentId}/commit`,
  });
...
export function getTrainingMaterialSources(
  ...
  const url = createUrl({
    pathname: `/api/training-materials/${params.persistentId}/sources`,
  });
  const options: RequestOptions = { ...requestOptions };
