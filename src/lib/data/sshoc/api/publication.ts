...
import { publicationInputSchema } from "@/lib/data/sshoc/validation-schemas/publication";
...
export function getPublicationHistory(
  ...
  const url = createUrl({
    pathname: `/api/publications/${params.persistentId}/history`,
  });
  const options: RequestOptions = { ...requestOptions };
...
export function commitDraftPublication(
  ...
  const url = createUrl({
    pathname: `/api/publications/${params.persistentId}/commit`,
  });
...
export function getPublicationSources(
  ...
  const url = createUrl({
    pathname: `/api/publications/${params.persistentId}/sources`,
  });
  const options: RequestOptions = { ...requestOptions };
