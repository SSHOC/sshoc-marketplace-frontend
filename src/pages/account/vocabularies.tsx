...
export async function getStaticProps(): Promise<GetStaticPropsResult<VocabulariesPage.Props>> {
...
export default function VocabulariesPage(_props: VocabulariesPage.Props): JSX.Element {
