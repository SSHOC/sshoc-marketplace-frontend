...
import { getDataset } from "@/lib/data/sshoc/api/dataset";
import { keys, useDataset } from "@/lib/data/sshoc/hooks/dataset";
...
): Promise<GetStaticPathsResult<DatasetPage.PathParams>> {
