...
- **Is the SSH Open Marketplace multilingual?**
  ...
  - The **description** can be in another language than English but If you want your resource to be discovered by users with all language backgrounds, we recommend that you add at least a short English description.
...
- **I am encountering an error when trying to log in. What can I do?**
  ...
  \
  If you cannot convince your university to release this information, another workaround is to use a different identity to log in. You can use your ORCID, but only if you have confirmed your e-mail address and did not set it to “trusted parties” or “everyone”.
