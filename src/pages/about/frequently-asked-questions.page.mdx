...
- **I am encountering an error when trying to log in. What can I do?**
  ...
  \
  If you cannot convince your university to release this information, another workaround is to use a different identity to log in. You can use your ORCID, but only if you have confirmed your e-mail address and set it to “trusted parties” or “everyone”.
