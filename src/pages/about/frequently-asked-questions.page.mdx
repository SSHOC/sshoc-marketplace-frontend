...
- **I am encountering an error when trying to log in. What can I do?**
  ...
  ![Screenshot of the ORCID email visibility settings](/assets/cms/images/screenshot-2024-03-12-at-10.18.26.png "Screenshot of the ORCID email visibility settings")
