...
<div style={{ display: 'grid', gap: 'var(--space-4)', gridTemplateColumns: 'var(--prose-column-xs) 1fr' }}>
  ...
  <div>
    ...
    *Example:* [Gephi](/tool-or-service/87wJWo) is a visualisation and exploration software for all
...
<div style={{ display: 'grid', gap: 'var(--space-4)', gridTemplateColumns: 'var(--prose-column-xs) 1fr' }}>
  ...
  <div>
    ...
    *Example:* The [lesson "Beginner's Guide to Twitter Data"](/training-material/7dimO5) (Programming
    Historian website).
