...
<ApiEndpoint title="Retrieve items by type" endpoint={{ key: 'item-search', pathname: '/api/item-search' }}>
  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
    <ApiParamSelect label="Category" param="categories" placeholder="Category">
      <Item key="tool-or-service">Tools or services</Item>
      <Item key="training-material">Training materials</Item>
      <Item key="dataset">Datasets</Item>
      <Item key="publication">Publications</Item>
      <Item key="workflow">Workflows</Item>
    </ApiParamSelect>
    <ApiParamSelect label="Page" param="page" placeholder="Page">
...
<ApiEndpoint title="Item search on specific fields" endpoint={{ key: 'item-search', pathname: '/api/item-search' }}>
  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
    <ApiParamTextField label="Source" param="d.source" placeholder="Search term" />
    <ApiParamTextField label="Contributor" param="d.contributor" placeholder="Search term" />
    <ApiParamTextField label="License" param="d.license" placeholder="Search term" />
    <ApiParamTextField label="Journal" param="d.journal" placeholder="Search term" />
    <ApiParamTextField label="Resource category" param="d.resource-category" placeholder="Search term" />
    <ApiParamSelect label="Page" param="page" placeholder="page">
      <Item key={1}>Page 1</Item>
      <Item key={2}>Page 2</Item>
      <Item key={3}>Page 3</Item>
...
<ApiEndpoint title="Item search on faceted fields" endpoint={{ key: 'item-search', pathname: '/api/item-search' }}>
  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
    <ApiParamTextField label="Activity" param="f.activity" placeholder="Search term" />
    <ApiParamTextField label="Keyword" param="f.keyword" placeholder="Search term" />
    <ApiParamTextField label="Language" param="f.language" placeholder="Search term" />
    <ApiParamSelect label="Page" param="page" placeholder="page">
      <Item key={1}>Page 1</Item>
      <Item key={2}>Page 2</Item>
      <Item key={3}>Page 3</Item>
...
<ApiEndpoint title="Concept search among the SSH Open marketplace vocabularies" endpoint={{ key: 'concept-search', pathname: '/api/concept-search' }}>
  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
    <ApiParamTextField label="Search" param="q" placeholder="Search concept" />
    <ApiParamSelect label="Page" param="page" placeholder="Page">
      <Item key={1}>Page 1</Item>
      <Item key={2}>Page 2</Item>
      <Item key={3}>Page 3</Item>
...
<summary>**Result**: New item stored in the database with the status `SUGGESTED`.</summary>
...
<summary>**Result**: New version of an existing item stored in the database with the status `SUGGESTED`.</summary>
