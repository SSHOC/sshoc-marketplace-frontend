...
export async function getStaticPaths(): Promise<
  GetStaticPathsResult<TrainingMaterialPage.PathParams>
> {
...
export default function TrainingMaterialPage(props: TrainingMaterialPage.Props): JSX.Element {
  ...
  const label = trainingMaterial?.label ?? t(`item-categories.${category}.one`)
  ...
  const breadcrumbs = [
    { href: '/', label: t('pages.home') },
    {
      ...
      label: t(`item-categories.${trainingMaterial.category}.other`),
    },
    {
