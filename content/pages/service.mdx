...
- Report issues. While waiting for more community features – such as the
  ...
  **Note:** On this Beta version, you will encounter some issues that are known
  to our development team. You will see for example that some tools or services
  are referenced several times. We are working on these record duplicates.
