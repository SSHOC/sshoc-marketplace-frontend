...
toc: true
---
These guidelines include recommendations on metadata fields to be used while creating and/or
reviewing an item entry in the SSH Open Marketplace.

The first subsection presents the fields that are mandatory and recommended depending on the type of
items you want to create. A second section gives some explanations about the fields themselves - in
case the title is not self-explanatory - how to fill in a field if you create an item and what you
should check if you are a moderator.

## Metadata status

- **Mandatory** fields are clearly indicated in the edit forms and you won't be able to submit an
  item if these fields are empty
- **Recommended** fields are present by default in the forms, depending on the item types you want
  to create (i.e. if you want to create a publication, all the bibliographic metadata are included
  by default in the edit forms).
...
<table data-metadata-table>
  ...
  <tbody>
    ...
    <tr>
      <th scope="row">technology-readiness-level</th>
      <td colSpan="1">recommended</td>
    </tr>
    <tr>
...
[^1]:
    Problematic items are automatically flagged and prioritised for curation within the editorial
    dashboard "Manually". Moderator has to assess coherence and relevance of the info
...
| intended-audience          | [audience](https://vocabs.sshopencloud.eu/vocabularies/sshoc-audience/audienceScheme)                                                                | closed             |
| mode-of-use                | [Invocation types](https://vocabs.sshopencloud.eu/vocabularies/invocation-type/invocationTypeScheme)                                                 | closed             |
| language                   | [ISO 639-3 Language Codes](https://vocabs.acdh.oeaw.ac.at/iso639_3/)                                                                                 | closed             |
| keyword                    | Keywords from SSHOC MP                                                                                                                               | open               |
| object-format              | [Media Types from IANA](https://vocabs.sshopencloud.eu/vocabularies/media-type/mediaTypeScheme)                                                      | closed             |
| discipline                 | [ÖFOS 2012. Austrian Fields of Science and Technology Classification 2012](https://vocabs.acdh.oeaw.ac.at/oefos/de/page/Schema)                      | closed             |
| license                    | [Software License from SPDX](https://vocabs.sshopencloud.eu/vocabularies/software-license/en/)                                                       | closed             |
| standard                   | [SSK Standards List](https://vocabs.sshopencloud.eu/vocabularies/standard/standardScheme)                                                            | closed             |
| activity                   | [TaDiRAH 2](https://vocabs.dariah.eu/tadirah/)                                                                                                       | closed             |
| publication-type           | [The Bibliographic Ontology Concept Scheme](https://vocabs.sshopencloud.eu/vocabularies/publication-type/en/)                                        | closed             |
