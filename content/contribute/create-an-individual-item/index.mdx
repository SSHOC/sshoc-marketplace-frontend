...
<Figure src="/assets/content/images/contribute/create-an-individual-item/sign-in-mai-1-2.png" alignment="stretch">
  Sign in the SSH Open Marketplace steps 1 and 2
</Figure>

<Figure src="/assets/content/images/contribute/create-an-individual-item/sign-in-mai-3.png" alignment="stretch">
  Sign in the SSH Open Marketplace step 3
</Figure>
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/myaccess_1.png" alignment="stretch">
  Joining the SSHOC Marketplace group on MyAccessID
</Figure>

<Figure src="/assets/content/images/contribute/create-an-individual-item/myaccess_2.png" alignment="stretch">
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/myaccess_3.png" alignment="stretch">
  Successful membership to MyAccessID
</Figure>

If you encounter any problem with logging in, or do not find your history of contributed items in your account, please get in touch with the team using the [contact form](/contact) or directly via [sshopenmarketplace@sshopencloud.eu](mailto:sshopenmarketplace@sshopencloud.eu).
...
* *Is this resource relevant to the SSH scientific community?*
* *Is the resource current, supported, and ideally open?*
* *Is the resource FAIR – Findable, Accessible, Interoperable and Re-usable - or contributing to the uptake of Open Science best practices?*
...
* *Is the resource already in the Marketplace?* Take a look at existing items, typing the name of your resource in the search. If the same item already exists, please consult the next section [*Edit/Enrich an item*](/contribute/enrich-an-individual-item). If you get no results, then you may proceed with the creation of your item!
...
<Grid layout="one-four-columns" alignment="stretch">
  <GridItem alignment="stretch">
    ![](/assets/content/images/contribute/create-an-individual-item/categories-tool-or-service.svg)
  </GridItem>
  ...
  <GridItem alignment="stretch">
    ![](/assets/content/images/contribute/create-an-individual-item/categories-training-material.svg)
  </GridItem>
  ...
  <GridItem alignment="stretch">
    ![](/assets/content/images/contribute/create-an-individual-item/categories-workflow.svg)
  </GridItem>
  ...
  <GridItem alignment="stretch">
    ![](/assets/content/images/contribute/create-an-individual-item/categories-dataset.svg)
  </GridItem>
  ...
  <GridItem alignment="stretch">
    ![](/assets/content/images/contribute/create-an-individual-item/categories-publication.svg)
  </GridItem>
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/create_mp.png" alignment="stretch">
  "Create an item" banner
</Figure>
...
*Note*: if you are creating a DARIAH national resource, you can also take a look at our [dedicated guidelines](https://doi.org/10.5281/zenodo.7410293).

<Figure src="/assets/content/images/contribute/create-an-individual-item/create-item.png" alignment="stretch">
  Edit form "Create a training material"
</Figure>
...
* **How to create a good description of a resource?**
  ...
  Description field supports Markdown, although to include links we recommend using the *See also* property.
* **What is the external ID field and how to fill it?**
  ...
  *Note*: these external identifiers are available both for Marketplace items (Wikidata, Github, DOI or Handle.Net identifiers) as well as for Actors (ORCID, Wikidata, Twitter or ROR identifiers).

  As shown below, to add an external ID to an item, you first need to click on "Add External ID", then to choose which type of IDs you want to add, and finally to add only the last part of the related URL (ex. only add DARIAH-ERIC/dariah-campus in the field if you want to refer to [https://github.com/DARIAH-ERIC/dariah-campus](https://github.com/DARIAH-ERIC/dariah-campus)). Below the field you can preview the generated URL.

<Figure src="/assets/content/images/contribute/create-an-individual-item/screenshot-2023-05-08-at-17.43.35.png" alignment="stretch">
  Add an external ID - step 1
</Figure>

<Figure src="/assets/content/images/contribute/create-an-individual-item/screenshot-2023-05-08-at-17.49.22.png" alignment="stretch">
  Add an external ID - steps 2 and 3
</Figure>
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/actor_notfound.jpg" alignment="stretch">
  Actor not found
</Figure>

2. You can create an actor using the "create actor" button on the right

<Figure src="/assets/content/images/contribute/create-an-individual-item/create_actor2.jpg" alignment="stretch">
  Create an actor button
</Figure>
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/screenshot-2023-05-08-at-18.02.19.png" alignment="stretch">
  Add actor external ID
</Figure>

*Note on the actors’ roles*. For a given item, you can choose a role for an actor: contributor, author, reviewer, director, programmer, editor, provider, contact, funder, helpdesk. By default, the Actor’s role is contributor.
...
Licensing information is very important (especially for the tools & services). Knowing at a glance under which conditions and with which licence a service is available can greatly facilitate its re-use. You can select a license, drawn from the controlled vocabulary SPDX License List. If you do not find any match in this vocabulary, please leave the license field empty and fill in the *terms of use*.

The *terms of use* field is a free text field, so you can add anything you want in it.
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/images_mp.png" alignment="stretch">
  Positions of the two different images in the item detail view of an item
</Figure>
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/screenshot-2023-06-16-at-15.36.36.png" alignment="stretch">
  Media pop-up window
</Figure>
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/screenshot-2023-06-16-at-15.38.39.png" alignment="stretch">
  Link to add to the MP highlighted in blue
</Figure>
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/screenshot-2023-06-16-at-15.44.35.png" alignment="stretch">
  2 steps describing how to add related items
</Figure>

**If you need some explanation or examples for some of the metadata fields, please consult the ["Guidance for metadata fields" table](/contribute/metadata-guidelines).**
...
<Figure src="/assets/content/images/contribute/create-an-individual-item/my_account_contrib.png" alignment="stretch">
  My contributor account
</Figure>
