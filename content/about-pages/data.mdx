...
An item or source has to match the following selection criteria:
...
* From a technical point of view, **the data must also be current, supported, and ideally open**. The SSH Open Marketplace favours the uptake of Open Science workflows and open research practices. Software resources are preferably built upon open source solutions.
...
* Finally, in terms of legal and ethical requirements, the SSH Open Marketplace maximises the findability and re-use of data in line with the **FAIR data principles** – Findable, Accessible, Interoperable and Re-usable – for research data, and guides users towards tools, services or training materials that can help them in their FAIRification of workflows.
