...
flexible enough to support a variety of sources. The data model v1.5 is presented in the [Marketplace – Implementation report](https://doi.org/10.5281/zenodo.5749464). 
...
*Illustration: Overview on the different components of the ingestion workflow*
