...
* not a repository. Nothing is hosted in the SSH Open Marketplace. Workflow
  content type can be hosted, but this is an exception
* not a data catalogue. The goal is not to collect all the SSH datasets, but
...
* not a commercial Marketplace. There is nothing to sell in the SSH Open
