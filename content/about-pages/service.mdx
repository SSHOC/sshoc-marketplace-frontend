...
materials, datasets, publications and workflows**. The Marketplace highlights and
showcases solutions and research practices for every step of the SSH research
data life cycle.

| **What is the SSH Open Marketplace?**                                                                                                                                                                                                                                                             | **What is it not?**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
\
An **entry point in the EOSC** for the Social Sciences and Humanities researchers | The SSH Open Marketplace is: \
\
not a repository. Nothing is hosted in the SSH Open Marketplace. Workflow content type can be hosted, but this is an exception \
\
not a data catalogue. The goal is not to collect all the SSH datasets, but selected datasets are indexed to support the contextualisation (dataset mentioned in a publication or used in a training material for example). \
\
not a commercial Marketplace. There is nothing to sell in the SSH Open Marketplace. Commercial software/services can be referenced. |
...
*Source:
[SSHOC project website](https://www.sshopencloud.eu/news/33-shocing-key-exploitable-results-support-your-research-ssh-and-beyond)*
...
An **[Editorial Team](/about/team)** ensures the day-to-day maintenance and the data quality of
the SSH Open Marketplace. The Editorial Team, liaising with the service
providers and the end-users of the service (SSH researchers and support staff
for researchers) ensures the technical running of operation, the effectiveness
of the curation process and the editorial policy's successful implementation.
...
* Clara Petitfils, Suzanne Dumouchel, Nicolas Larrousse, Edward J. Gray, Laure Barbot, Arnaud Roi, Matej Ďurčo, Klaus Illmayer, Stefan Buddenbohm, & Tomasz Parkola. (2021). D7.5 Marketplace - Governance. [https://doi.org/10.5281/zenodo.5608487\](https://doi.org/10.5281/zenodo.5608487\)
* MS44 report Marketplace final release will be added soon

Several consultations and presentations of the SSH Open Marketplace have been given in recent years, some examples and references:
...
If you want to promote the SSH Open Marketplace as part of your own work, do not hesitate to reuse some of these materials, and to [let the team](/about/team) know about it, so that your work can also be referenced in the list above.