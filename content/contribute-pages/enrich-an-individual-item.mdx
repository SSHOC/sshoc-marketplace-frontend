...
---
If you find an existing Marketplace entry that you wish to enhance or correct, you can do so via the edit forms. To access this, log in to your Marketplace account and go to the item you wish to correct. Above the entry, in blue, you will find an “Edit” button, which will open up a page where you can fill in the information.
...
If you need some explanation or examples for some of the metadata fields, please consult the <“Guidance for metadata fields” table>. 
